        ...
        this.script =
            when (stageNum) {
                ...
                21 -> arrayOf(
                    ...
                    "악마성에서 쓸 마법책이 있네",
                    "줍고 가자!",
                    "위에는 변수라고 해요. 아이템이 있는지 없는지와 그 개수에요"
                )
                ...
                // for 설명
                31 -> arrayOf(
                    "광석에서 나오는 특수한 에너지가 포탈을 막고있어. ",
                    "포탈을 막는 광석을 모두 캐야 해",
                    "광석을 부셔 포탈을 열어보자!",
                    "for는 반복이에요. 안에 넣은 숫자만큼 반복해요."
                )

                32 -> arrayOf(
                    "광석을 부셔 포탈을 열어보자!",
                    "포탈을 막고 있는 박쥐를 죽여야 지나 갈 수 있을 것 같아"
                )

                33 -> arrayOf(
                    "박쥐를 죽여야하는데 광석이 막고있네..",
                    "박쥐를 막고 있는 광석을 캐면 가능 할 것 같아"
                )

                41 -> arrayOf(
                    "새로운 마을에 도착했어!",
                    "마을에 들어가야 하는데 저건 뭐지? 나는 갈 길이 바쁘다고...",
                    "앞에 가서 싸워야겠어!"
                )
                42 -> arrayOf("도저히 이길 수가 없잖아...", "얼른 이곳을 벗어나자!", "코드를 다 쓸 수 없으니 8줄 이내로 탈출 해 볼끼?!")

                43-> arrayOf("아니야 이대로 포기할 수 없어", "다시 가보자!")

                51-> arrayOf("악마성에 왕자가 잡혀 있어", "보스를 물리쳐야 해")
                52-> arrayOf("드디어 악마왕을 만났어")
